...
K <- 3000 # the number of simulation iterations
```
...
### b) [new] [95%] Calculations and results
...
K_increment <- 500 # note: for the 95% confidence, need around K=3000 to be within the desired margin or error
...
critical_value <- 1.959964 # critical value for 95%
...
if (actual_margin_of_error <= desired_margin_of_error) {
  ...
  "Measure" = c("Estimated E(C12) with 95% confidence within £500 of true (£)",
                "Lower bound of confidence interval (£)",
                "Upper bound of confidence interval (£)",
                "Difference in upper and lower bounds (£)",
                "Variance of estimate for C12",
...
hist(capital, breaks = 100, main = "Histogram of Capital Values 95% confidence (K=3000)", xlab = "Capital", ylab = "Frequency")
